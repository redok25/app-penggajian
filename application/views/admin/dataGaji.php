<div class="container-fluid">
    ...
    <div class="card mb-3">
		  ...
		  <div class="card-body">
				<form class="form-inline">
				  ...
				  <?php }else{ ?>
				  	<button type="button" class="btn btn-success mb-2 ml-2" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-print"></i> Cetak Daftar Gaji
					</button>
				  <?php } ?>
				</form>
		  </div>
  ...
  <?php }else{ ?>
	...
	<span class="badge badge-danger">
		<i class="fas fa-info-circle"></i> Data absensi masih kosong, silahkan input data pada bulan dan tahun yang anda pilih
	</span>
	<?php } ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Data Gaji masiih kosong, silahkan input data terlebih dahulu pada bulan dan tahun yang anda pilh.
      </div>
